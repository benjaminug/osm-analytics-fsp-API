!function (e, t) {
    ...
    return function (e) {
        ...
        var s = function () {
            ...
            return a(t, e), s(t, [
                {key: "render", value: function () {
                    var e = this.props, t = e.getComponent, o = e.specSelectors, r = t("Container"), n = t("Row"), i = t("Col"), a = t("Topbar", !0), s = t("BaseLayout", !0), l = t("onlineValidatorBadge", !0), u = o.loadingStatus();
        ...
        "use strict";
        var r = o(5), n = o(6), i = o(19), a = o(22), s = o(23), l = o(25), p = o(10), u = o(26), c = o(31), f = o(32), d = (o(12), p.createElement), g = p.createFactory, b = p.cloneElement, m = r, x = {Children: {map: n.map, forEach: n.forEach, count: n.count, toArray: n.toArray, only: f}, Component: i, PureComponent: a, createElement: d, cloneElement: b, isValidElement: p.isValidElement, PropTypes: u, createClass: s.createClass, createFactory: g, createMixin: function (e) {
            return e
        }, DOM: l, version: c, __spread: m};
        e.exports = x
    }, function (e, t) {/*
     object-assign
     (c) Sindre Sorhus
     ...
     */
        ...
        var i = o(5), a = o(11), s = (o(12), o(14), Object.prototype.hasOwnProperty), l = o(15), p = {key: !0, ref: !0, __self: !0, __source: !0}, u = function (e, t, o, r, n, i, a) {
        ...
        function r(e) {
            var t = /(=0|=2)/g, o = {"=0": "=", "=2": ":"}, r = "." === e[0] && "$" === e[1] ? e.substring(2) : e.substring(1);
        ...
        var n = (o(12), {isMounted: function (e) {
            return!1
        ...
        var f = o(8), d = o(5), g = o(19), b = o(10), m = (o(24), o(20)), x = o(21), w = (o(9), o(12), "mixins"), h = [], y = {mixins: "DEFINE_MANY", statics: "DEFINE_MANY", propTypes: "DEFINE_MANY", contextTypes: "DEFINE_MANY", childContextTypes: "DEFINE_MANY", getDefaultProps: "DEFINE_MANY_MERGED", getInitialState: "DEFINE_MANY_MERGED", getChildContext: "DEFINE_MANY_MERGED", render: "DEFINE_ONCE", componentWillMount: "DEFINE_MANY", componentDidMount: "DEFINE_MANY", componentWillReceiveProps: "DEFINE_MANY", shouldComponentUpdate: "DEFINE_ONCE", componentWillUpdate: "DEFINE_MANY", componentDidUpdate: "DEFINE_MANY", componentWillUnmount: "DEFINE_MANY", updateComponent: "OVERRIDE_BASE"}, k = {displayName: function (e, t) {
            e.displayName = t
        }, mixins: function (e, t) {
        ...
        e.exports = function (e, t) {
            ...
            var A = "function" == typeof Symbol && Symbol.iterator, P = "@@iterator", S = "<<anonymous>>", j = {array: u("array"), bool: u("boolean"), func: u("function"), number: u("number"), object: u("object"), string: u("string"), symbol: u("symbol"), any: c(), arrayOf: f, element: d(), instanceOf: g, node: w(), objectOf: m, oneOf: b, oneOfType: x, shape: h};
            return l.prototype = Error.prototype, j.checkPropTypes = a, j.PropTypes = j, j
        }
    }, function (e, t) {
        "use strict";
        ...
        var s = function () {
        ...
        }(), l = o(3), p = r(l), u = o(39), c = r(u), f = function (e) {
            function t(e, o) {
                n(this, t);
            ...
            return a(t, e), s(t, [
                ...
                {key: "render", value: function () {
                    ...
                    return a && (s.color = "red"), i && (s.color = "#aaa"), p.default.createElement("div", {className: "topbar"}, p.default.createElement("div", {className: "wrapper"}, p.default.createElement("div", {className: "topbar-wrapper"}, p.default.createElement(n, {href: "#", title: "Swagger UX"}, p.default.createElement("img", {height: "30", width: "30", src: c.default, alt: "Swagger UX"}), p.default.createElement("span", null, "swagger")), p.default.createElement("form", {className: "download-url-wrapper", onSubmit: this.downloadUrl}, p.default.createElement("input", {className: "download-url-input", type: "text", onChange: this.onUrlChange, value: this.state.url, disabled: i, style: s}), p.default.createElement(r, {className: "download-url-button", onClick: this.downloadUrl}, "Explore")))))
                }}
            ]), t
        }(p.default.Component);
